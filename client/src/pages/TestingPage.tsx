...
import { 
  ...
  Beef, Fish, Drumstick, Ham,
  Carrot, Salad,
  Pizza, Sandwich, Soup, Cake, IceCream, Wine, Beer,
  Flame, Star, Heart, Utensils, Wheat,
  Target, Gem, Crown, Gift, Sun, Leaf, Droplets, Snowflake
} from "lucide-react";
...
export function TestingPage() {
  ...
  const foodIcons: IconData[] = [
    ...
    { component: <Target className="w-6 h-6 text-yellow-600" />, name: "Grains", category: "vegetables", keywords: ["corn", "grain", "vegetable", "quinoa", "rice"] },
      ...
      <Card className="border-dashed">
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <ul className="text-sm text-muted-foreground space-y-1">
                <li>• Ingredient complexity analysis with 40+ pre-defined ingredients</li>
                <li>• Cooking method detection (sautéing, baking, grilling, etc.)</li>
                <li>• Advanced technique recognition (julienne, sous vide, etc.)</li>
                <li>• Parallel cooking time optimization</li>
              </ul>
            </div>
            <div>
              <h4 className="font-semibold mb-2">Smart Features</h4>
              <ul className="text-sm text-muted-foreground space-y-1">
                <li>• Constraint validation against user preferences</li>
                <li>• Difficulty-based cooking recommendations</li>
                <li>• Easy alternative suggestions for complex recipes</li>
                <li>• Integration with meal planning pipeline</li>
              </ul>
            </div>
          </div>
          ...
          <div className="bg-muted/50 p-4 rounded-lg">
            <p className="text-sm">
              <strong>Note:</strong> This system is now integrated into the meal planning process. 
              When you generate meal plans, each recipe is automatically analyzed for timing and difficulty, 
              ensuring they match your specified constraints and preferences.
            </p>
          </div>
        </CardContent>
      </Card>
